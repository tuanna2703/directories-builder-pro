...
<section class="dbp-business-about">
    <?php if ( $description ) : ?>
        <div class="dbp-business-about__description">
            ...
            <div class="dbp-business-about__text"><?php echo $description; // phpcs:ignore WordPress.Security.EscapeOutput ?></div>
        </div>
    <?php endif; ?>
    <!-- Attributes Grid -->
    <?php
    ...
    <?php if ( $lat && $lng ) : ?>
        <div class="dbp-business-about__map">
            ...
            <?php if ( $address ) : ?>
                <p class="dbp-business-about__address"><?php echo $address; // Already escaped. ?></p>
            <?php endif; ?>
