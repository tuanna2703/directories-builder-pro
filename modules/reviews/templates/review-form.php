 ...
 *
 * Interactive review submission form with star picker, textarea, and photo upload.
 *
...
<div class="dbp-review-form-wrapper" id="dbp-review-form-wrapper">
    <?php if ( ! is_user_logged_in() ) : ?>
        ...
        <div class="dbp-review-form__login-prompt">
            <div class="dbp-review-form__login-icon">
                <svg viewBox="0 0 24 24" width="32" height="32">
                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z" fill="currentColor"/>
                </svg>
            </div>
            <p class="dbp-review-form__login-text">
                <?php esc_html_e( 'Log in to write a review', 'directories-builder-pro' ); ?>
            </p>
                ...
                <div class="dbp-review-form__photos">
                    ...
                    <div class="dbp-photo-upload" id="dbp-photo-upload">
                        <div class="dbp-photo-upload__dropzone" id="dbp-dropzone">
                            <svg viewBox="0 0 24 24" width="32" height="32" class="dbp-photo-upload__icon">
