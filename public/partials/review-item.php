 ...
 *
 * @var array $review      Review data array.
 * @var int   $business_id Business ID.
 *
...
$time_ago      = $review['time_ago'] ?? dbp_time_ago( $review['created_at'] ?? '' );
...
<div class="dbp-review-item" id="dbp-review-<?php echo esc_attr( (string) $review_id ); ?>" data-review-id="<?php echo esc_attr( (string) $review_id ); ?>">
    <div class="dbp-review-item__header">
        <div class="dbp-review-item__avatar">
            ...
            <?php else : ?>
                <?php echo get_avatar( $user_id, 40, '', $author_name ); ?>
            <?php endif; ?>
        </div>
        <div class="dbp-review-item__author-info">
            ...
            <?php if ( $is_elite ) : ?>
                <span class="dbp-badge dbp-badge--elite"><?php esc_html_e( 'Elite', 'directories-builder-pro' ); ?></span>
            <?php endif; ?>
            <div class="dbp-review-item__meta">
                <?php echo dbp_get_star_html( (float) $rating, false ); // phpcs:ignore WordPress.Security.EscapeOutput ?>
    ...
    <div class="dbp-review-item__content">
        <?php if ( mb_strlen( $content ) > 300 ) : ?>
            <p class="dbp-review-item__text dbp-review-item__text--truncated" id="dbp-review-text-<?php echo esc_attr( (string) $review_id ); ?>">
                <?php echo esc_html( mb_substr( $content, 0, 300 ) ); ?>…
            </p>
    ...
    <?php if ( ! empty( $response ) ) : ?>
        <div class="dbp-review-item__response">
            <div class="dbp-review-item__response-header">
                <span class="dbp-badge dbp-badge--owner"><?php esc_html_e( 'Business Owner', 'directories-builder-pro' ); ?></span>
