 ...
 *
 * Stats cards, quick links, and recent activity table.
 *
 ...
 *                 recent_activity (array) — recent review arrays with business_name
 *
 * @package DirectoriesBuilderPro\Templates\Admin
 */
$stats    = $args['stats'] ?? [];
$activity = $args['recent_activity'] ?? [];

$total_businesses  = (int) ( $stats['total_businesses'] ?? 0 );
$reviews_this_week = (int) ( $stats['reviews_this_week'] ?? 0 );
$pending_claims    = (int) ( $stats['pending_claims'] ?? 0 );
    ...
    <div class="dbp-stats-grid">
        <div class="dbp-stat-card">
            ...
            <div class="dbp-stat-card__data">
                <span class="dbp-stat-card__number"><?php echo esc_html( (string) $total_businesses ); ?></span>
        ...
        <div class="dbp-stat-card">
            ...
            <div class="dbp-stat-card__data">
                <span class="dbp-stat-card__number"><?php echo esc_html( (string) $reviews_this_week ); ?></span>
        ...
        <div class="dbp-stat-card">
            ...
            <div class="dbp-stat-card__data">
                <span class="dbp-stat-card__number"><?php echo esc_html( (string) $pending_claims ); ?></span>
        ...
        <div class="dbp-stat-card">
            ...
            <div class="dbp-stat-card__data">
                <span class="dbp-stat-card__number"><?php echo esc_html( (string) $pending_reviews ); ?></span>
    ...
    <div class="dbp-recent-activity">
        ...
        <?php else : ?>
            <table class="wp-list-table widefat fixed striped">
                ...
                <tbody>
                    <?php foreach ( $activity as $review ) :
